...
MiniCart::set_return_url("http://ec2-176-32-77-19.ap-northeast-1.compute.amazonaws.com/paypal.php");
MiniCart::set_cancel_return_url("http://ec2-176-32-77-19.ap-northeast-1.compute.amazonaws.com/paypal.php");
