<li class="productItem">
	...
	<% else %>
		<a href="$Link" title="Click here to read more on &quot;{$Title}&quot;"><img src="themes/darkritual_ecommerce/images/productPlaceHolderThumbnail.gif" alt="Sorry, no product image for &quot;{$Title}&quot;" /></a>
	<% end_if %>
